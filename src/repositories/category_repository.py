...
class CategoryRepository(Repository):
    @abstractmethod
    async def get_all_parent_categories(self, conn: Connection) -> list[Category]:
        ...

    @abstractmethod
    async def get_all_subcategories(
        self, category_slug: str, conn: Connection
    ) -> list[Category]:
        ...
...
class CategoryRepositoryImpl(CategoryRepository):
    ...
    async def get_all_subcategories(
        ...
        return await super().get_all_subcategories(category_slug)
